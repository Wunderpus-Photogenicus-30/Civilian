...
const mapStateToProps = ({ title, location, details, time, videoUrl }) => ({
  title,
  location,
  details,
  time,
...
const ExpandedPost = (props) => {
  return (
    <div className='expanded-post'>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16" onClick={props.setExpandedPost('hidden')}>
